    ...
    public function admin_notices() {
        ...
        if ( $error ) {
            ...
            <div class="notice notice-error is-dismissible">
                <p>
                    <?php
                    echo sprintf( __( '%s: Error(s) occured when attempting to add some/all status updates to %s. Please check the log at the bottom of this screen for further details.', $this->base->plugin->name ), $this->base->plugin->displayName, $this->base->plugin->account );
                    ?> 
                </p>
            </div>
            <?php
