<?php $field_type = apply_filters( 'inventor_filter_field_type', 'SELECT', 'food-kind' ); ?>
<?php $field_name = $field_type == 'SELECT' ? 'food-kind' : 'food-kinds'; ?>
<?php $taxonomy = 'food_kinds'; ?>
<?php $selected = empty( $_GET[ $field_name ] ) ? null : $_GET[ $field_name ]; ?>

<?php if ( empty( $instance['hide_food-kind' ] ) ) : ?>
    <div class="form-group form-group-food-kind">
        <?php if ( 'labels' == $input_titles ) : ?>
            <label for="<?php echo ! empty( $field_id_prefix ) ? $field_id_prefix : ''; ?><?php echo esc_attr( $args['widget_id'] ); ?>_food_kind"><?php echo __( 'Food Kind', 'inventor' ); ?></label>
        <?php endif; ?>
        ...
        <?php if ( $field_type == 'SELECT' ): ?>
            ...
            <select class="form-control"
                    ...
                    id="<?php echo ! empty( $field_id_prefix ) ? $field_id_prefix : ''; ?><?php echo esc_attr( $args['widget_id'] ); ?>_food_kind">
                <option value="">
                    <?php if ( 'placeholders' == $input_titles ) : ?>
                        <?php echo __( 'Food Kind', 'inventor' ); ?>
                    <?php else : ?>
                        <?php echo __( 'All kinds', 'inventor' ); ?>
                    <?php endif; ?>
                </option>
