...
<?php if ( class_exists( 'Inventor_Template_Loader' ) ) : ?>
    ...
    <?php if ( in_array( $field_type, array( 'text', 'text_small', 'text_medium', 'text_email', 'text_url', 'text_date_timestamp', 'text_datetime_timestamp', 'text_datetime_timestamp_timezone', 'textarea', 'textarea_small', 'textarea_code', 'wysiwyg' ) ) ): ?>
