...
function superlist_enqueue_files() {
	...
	wp_enqueue_style( 'montserrat', '//fonts.googleapis.com/css?family=Montserrat:300,400,500,700&subset=latin,latin-ext' );
	wp_enqueue_style( 'lato', '//fonts.googleapis.com/css?family=Lato:300,400,500,700&subset=latin,latin-ext' );
	...
	wp_enqueue_style( 'superlist', get_template_directory_uri() . '/assets/css/' . $style, array(), '20180226' );
	wp_enqueue_style( 'style', get_stylesheet_directory_uri() . '/style.css', '20180226' );
...
//    wp_enqueue_script( 'video-provider-vimeo', get_template_directory_uri() . '/assets/js/video-providers/vimeo.js', array( 'jquery' ));
    wp_enqueue_script( 'superlist', get_template_directory_uri() . '/assets/js/superlist.js', array( 'jquery' ), '20170427' );
}
...
function superlist_menus() {
	register_nav_menus( array(
		'main' 		=> __( 'Main', 'superlist' ),
		'user-menu' => __( 'User menu', 'superlist' ),
		)
	);
}
 ...
 * Print
 *
 * @action inventor_listing_banner_actions
 * @return void
 */
...
add_action( 'inventor_listing_banner_actions', 'superlist_render_print_button', 100 );
...
function superlist_customizations( $wp_customize ) {
	...
	// User menu
	$wp_customize->add_setting( 'superlist_general_user_menu', array(
		'default'           => false,
		'capability'        => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
	) );

	$wp_customize->add_control( 'superlist_general_user_menu', array(
		'label'             => __( 'User menu', 'superlist' ),
		'section'           => 'superlist_general',
		'settings'          => 'superlist_general_user_menu',
		'type'              => 'checkbox',
	) );
